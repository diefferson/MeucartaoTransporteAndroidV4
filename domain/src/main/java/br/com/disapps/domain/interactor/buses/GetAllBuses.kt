...
class GetAllBuses(private val busesRepository: BusesRepository,
                  val contextExecutor: ContextExecutor, val postExecutionContext: PostExecutionContext) : UseCase<List<Bus>, GetAllBuses.Params>(contextExecutor,postExecutionContext){
