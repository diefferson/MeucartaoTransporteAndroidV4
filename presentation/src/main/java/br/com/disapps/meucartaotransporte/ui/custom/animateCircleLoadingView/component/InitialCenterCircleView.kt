 ...
 * @author jlmd
 */
class InitialCenterCircleView(context: Context, parentWidth: Int, mainColor: Int,
                              secondaryColor: Int) : ComponentViewAnimation(context, parentWidth, mainColor, secondaryColor) {

    private var paint: Paint? = null
    private var oval: RectF? = null
    private var minRadius: Float = 0.toFloat()
    private var currentCircleWidth: Float = 0.toFloat()
    private var currentCircleHeight: Float = 0.toFloat()
    ...
    fun startTranslateBottomAnimation() {
        ...
        val translationY = ObjectAnimator.ofFloat(this, "translationY", translationYFrom, translationYTo)
    ...
    fun startScaleDisappear() {
        ...
        valueScaleWidthAnimator.addListener(object : Animator.AnimatorListener {
            override fun onAnimationStart(animation: Animator) {
                // Empty
            }
