    ...
    private val adapter: ConfigureCardsListAdapter by lazy {
        ConfigureCardsListAdapter(ArrayList()).apply {
            setOnItemClickListener { adapter, _, position ->
                ...
                saveCodeCard(this@CardBalanceWidgetWhiteConfigureActivity, mAppWidgetId, (adapter.data[position] as CardVO).code)
...
//        // Encontre o id do widget da intenção.
    ...
    companion object {
        ...
        private const val PREFS_NAME = "br.com.disapps.meucartaotransporte.widgets.cardBalance.CardBalanceWidgetWhite"
