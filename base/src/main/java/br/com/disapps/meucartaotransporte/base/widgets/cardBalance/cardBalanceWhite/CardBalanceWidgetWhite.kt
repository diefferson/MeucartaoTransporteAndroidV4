package br.com.disapps.meucartaotransporte.base.widgets.cardBalance.cardBalanceWhite
...
import br.com.disapps.meucartaotransporte.base.widgets.cardBalance.cardBalanceWhite.CardBalanceWidgetWhiteConfigureActivity.Companion.PREFS_NAME
import br.com.disapps.meucartaotransporte.base.widgets.cardBalance.cardBalanceWhite.CardBalanceWidgetWhiteConfigureActivity.Companion.PREF_PREFIX_KEY
...
class CardBalanceWidgetWhite : AppWidgetProvider() {
    ...
    private fun scheduleUpdate(context: Context, appWidgetId: Int) {
        val intent = Intent(context, CardBalanceWidgetWhite::class.java).apply {
            action = UPDATE_CARD
    ...
    companion object {
        ...
        private const val UPDATE_CARD = "br.com.disapps.meucartaotransporte.base.widgets.cardBalance.cardBalanceWhite.UPDATE_CARD"
