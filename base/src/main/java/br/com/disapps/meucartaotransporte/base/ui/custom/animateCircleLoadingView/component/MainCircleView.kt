 ...
 * @author jlmd
 */
class MainCircleView(context: Context, parentWidth: Int, mainColor: Int, secondaryColor: Int) : ComponentViewAnimation(context, parentWidth, mainColor, secondaryColor) {
